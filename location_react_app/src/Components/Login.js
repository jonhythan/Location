...
const Login = ()=>{
    ...
    return(
        ...
        <form onSubmit={handleSubmit}>
            ...
            <input type="email" value={courriel} onChange={e=>setCourriel(e.target.value)} placeholder="Émail" required/>
            ...
            <br></br>
            <input type="text" value={numRue} onChange={e=>setNumRue(e.target.value)} pattern="[1-9]" placeholder="Numéro rue"/>
            ...
            <input type="text" value={codePostal} onChange={e=>setCodePostal(e.target.value)} placeholder="Code Postal" pattern="[a-zA-z1-9]{3}-[a-zA-z1-9]{3}" required/>
