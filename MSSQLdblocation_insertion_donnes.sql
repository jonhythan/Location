...
INSERT INTO utilisateur (nom,prenom,courriel,telephone,password,num_rue,nom_rue,ville,province,codePostal) 
				 VALUES ('IMANI','AZI','AZI.i@GMAIL.COM',5144621235,'123123',101,'Maisonneuve','Montreal','QC','H3H2H1');
INSERT INTO utilisateur (nom,prenom,courriel,telephone,password,num_rue,nom_rue,ville,province,codePostal) 
...
INSERT INTO Membre(utilisateur_id,status,Administrateur_id_desactivateur,Administrateur_id_activateur) VALUES(1,1,null,1); 
INSERT INTO Membre(utilisateur_id,status,Administrateur_id_desactivateur,Administrateur_id_activateur) VALUES(2,0,1,null);
INSERT INTO Membre(utilisateur_id,status,Administrateur_id_desactivateur,Administrateur_id_activateur) VALUES(3,1,null,1);

INSERT INTO MESSAGE(expediteur_id,recepteur_id,contenu,dateEnvol) VALUES(2,3,'text1',GETDATE());
INSERT INTO MESSAGE(expediteur_id,recepteur_id,contenu,dateEnvol) VALUES(1,2,'text2',GETDATE());
INSERT INTO MESSAGE(expediteur_id,recepteur_id,contenu,dateEnvol) VALUES(3,2,'text3',GETDATE());
INSERT INTO MESSAGE(expediteur_id,recepteur_id,contenu,dateEnvol) VALUES(1,3,'text4',GETDATE());
...
INSERT INTO Annonce(utilisateur_proprietaire_id,categorie_id,etatOutil_id,Administrateur_id_activateur,Administrateur_id_desactivateur, titre ,description ,status ,date_creation, image)
			VALUES(2,1,2,null, 1, 'Titre Annonce 1','Description Annonce 1',0,GETDATE(), 010101);
INSERT INTO Annonce(utilisateur_proprietaire_id,categorie_id,etatOutil_id,Administrateur_id_activateur, Administrateur_id_desactivateur,titre ,description ,status ,date_creation, image)
			VALUES(3,2,4,null, 1, 'Titre Annonce 2','Description Annonce 2',0,GETDATE(), 010101);	
INSERT INTO Annonce(utilisateur_proprietaire_id,categorie_id,etatOutil_id,Administrateur_id_activateur,Administrateur_id_desactivateur,titre ,description ,status ,date_creation, image)            
			VALUES(3,3,1,1,null,'Titre Annonce 3','Description Annonce 3',1,GETDATE(), 010101);	
INSERT INTO Annonce(utilisateur_proprietaire_id,categorie_id,etatOutil_id,Administrateur_id_activateur,Administrateur_id_desactivateur,titre ,description ,status ,date_creation, image)
			VALUES(1,4,3,1,null,'Titre Annonce 4','Description Annonce 4',1,GETDATE(), 010101);		
...
INSERT INTO Evaluation(Annonce_id,Membre_id,Note,commentaire,dateEvaluation) VALUES(1,2,5,'commentaire 1',GETDATE());
INSERT INTO Evaluation(Annonce_id,Membre_id,Note,commentaire,dateEvaluation) VALUES(2,2,6,'commentaire 2',GETDATE());
INSERT INTO Evaluation(Annonce_id,Membre_id,Note,commentaire,dateEvaluation) VALUES(3,3,7,'commentaire 3',GETDATE());
INSERT INTO Evaluation(Annonce_id,Membre_id,Note,commentaire,dateEvaluation) VALUES(4,1,8,'commentaire 4',GETDATE());

INSERT INTO Signalement(MembreUtilisateur_id,AnnonceId,Administrateur_id,raison,dateSignalement) VALUES(3,4,null,'Raison 1',GETDATE());
INSERT INTO Signalement(MembreUtilisateur_id,AnnonceId,Administrateur_id,raison,dateSignalement) VALUES(2,2,1,'Raison 2',GETDATE());
INSERT INTO Signalement(MembreUtilisateur_id,AnnonceId,Administrateur_id,raison,dateSignalement) VALUES(3,3,null,'Raison 3',GETDATE());
INSERT INTO Signalement(MembreUtilisateur_id,AnnonceId,Administrateur_id,raison,dateSignalement) VALUES(1,1,1,'Raison 4',GETDATE());
