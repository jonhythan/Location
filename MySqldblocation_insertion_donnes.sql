...
INSERT INTO Annonce(utilisateur_proprietaire_id,categorie_id,etatOutil_id,Administrateur_id_activateur,Administrateur_id_desactivateur, titre ,description ,image, status ,date_creation)
			VALUES(2,1,2,null, 1, 'Titre Annonce 1','Description Annonce 1', 010101, 0, CURRENT_TIMESTAMP());
INSERT INTO Annonce(utilisateur_proprietaire_id,categorie_id,etatOutil_id,Administrateur_id_activateur, Administrateur_id_desactivateur,titre ,description ,image, status ,date_creation)
			VALUES(3,2,4,null, 1, 'Titre Annonce 2','Description Annonce 2', 010101, 0, CURRENT_TIMESTAMP());	
INSERT INTO Annonce(utilisateur_proprietaire_id,categorie_id,etatOutil_id,Administrateur_id_activateur,Administrateur_id_desactivateur,titre ,description ,image, status ,date_creation)            
			VALUES(3,3,1,1,null,'Titre Annonce 3','Description Annonce 3', 010101, 1, CURRENT_TIMESTAMP());	
INSERT INTO Annonce(utilisateur_proprietaire_id,categorie_id,etatOutil_id,Administrateur_id_activateur,Administrateur_id_desactivateur,titre ,description ,image, status ,date_creation)
			VALUES(1,4,3,1,null,'Titre Annonce 4','Description Annonce 4', 010101, 1, CURRENT_TIMESTAMP());		
